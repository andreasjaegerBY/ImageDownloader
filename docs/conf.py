...
project = u'image_downloader'
copyright = u'2015, Andreas Jaeger'
...
htmlhelp_basename = 'image_downloader-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'image_downloader Documentation',
   u'Andreas Jaeger', 'manual'),
]
